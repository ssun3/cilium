...
const AgentEventType_UNSPECIFIED = flow.AgentEventType_UNSPECIFIED
const AgentEventType_START = flow.AgentEventType_START
...
const AgentEventType_ENDPOINT_REGENERATE_FAIL = flow.AgentEventType_ENDPOINT_REGENERATE_FAIL
...
type AgentEvent_Start = flow.AgentEvent_Start
...
type AgentEvent_ServiceUpserted = flow.AgentEvent_ServiceUpserted
type AgentEvent_ServiceDeleted = flow.AgentEvent_ServiceDeleted
...
func (x *GetFlowsResponse) GetAgentEvents() *flow.AgentEvent {
	if x, ok := x.GetResponseTypes().(*GetFlowsResponse_AgentEvents); ok {
...
type GetFlowsResponse_AgentEvents struct {
	// agent_events informs clients about events received from the Cilium
	// agent.
	AgentEvents *flow.AgentEvent `protobuf:"bytes,4,opt,name=agent_events,json=agentEvents,proto3,oneof"`
}
...
func (*GetFlowsResponse_AgentEvents) isGetFlowsResponse_ResponseTypes() {}
...
var file_observer_observer_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0x8b, 0x02, 0x0a, 0x0f,
	...
	0x74, 0x69, 0x6c, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xbb, 0x02, 0x0a, 0x10, 0x47, 0x65,
	...
	0x35, 0x0a, 0x0c, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x41, 0x67, 0x65,
	0x6e, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x6e,
	...
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x32, 0xa2, 0x01, 0x0a, 0x08, 0x4f, 0x62, 0x73, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x4f, 0x0a, 0x0c, 0x53,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1d, 0x2e, 0x6f, 0x62,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x6f, 0x62, 0x73,
	...
	0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50, 0x02, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_observer_observer_proto_goTypes = []interface{}{
	...
	(*flow.AgentEvent)(nil),       // 10: flow.AgentEvent
}
var file_observer_observer_proto_depIdxs = []int32{
	...
	10, // 9: observer.GetFlowsResponse.agent_events:type_name -> flow.AgentEvent
	6,  // 10: observer.GetFlowsResponse.time:type_name -> google.protobuf.Timestamp
	2,  // 11: observer.Observer.GetFlows:input_type -> observer.GetFlowsRequest
	0,  // 12: observer.Observer.ServerStatus:input_type -> observer.ServerStatusRequest
	3,  // 13: observer.Observer.GetFlows:output_type -> observer.GetFlowsResponse
	1,  // 14: observer.Observer.ServerStatus:output_type -> observer.ServerStatusResponse
...
func file_observer_observer_proto_init() {
	...
	file_observer_observer_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*GetFlowsResponse_AgentEvents)(nil),
	}
	type x struct{}
